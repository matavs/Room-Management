...
export default function RoomTimer({ endTime, status, style }) {
  ...
  return (
    <View style={[{ flexDirection: "row", alignItems: "center", paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4, backgroundColor: "rgba(255,159,67,0.12)" }, style]}>
      <Ionicons name="time-outline" size={12} color="#FFD166" />
      <Text style={{ color: "#FFD166", marginLeft: 6, fontSize: 11, fontWeight: "600" }}>{timeLeft}</Text>
    </View>
  );
}